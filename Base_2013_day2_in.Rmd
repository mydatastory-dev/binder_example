...
title: Data Management Plan for the Study _Do Reputable Open Access Journals Require
  Open Data Sharing
author: Principal Investigator - 'Dan Maxwell, `r params$institution`
...
Dan Maxwell, Principal Investigator, University of Florida
...
2. The J. Bohannan Foundation adheres to the open access and data sharing policies of the [Gates Foundation](https://www.gatesfoundation.org/How-We-Work/General-Information/Open-Access-Policy)
...
|7| Journal article | Publisher website (open access) | Metadata | The journal metadata contained | 
...
Dr. Dan Maxwell presently works at `r params$institution` as an informatics consultant in the Marston Science Library. 
...
res <- orcid_bio(orcid = "0000-0002-4115-2727")
bio <- res$'0000-0002-4115-2727'$'content'
